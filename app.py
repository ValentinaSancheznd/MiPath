...
# ═══════════════════════════════════════════════════════════════════════════
# FILTERS — sidebar is always present. Field of study shows on every tab
# (synced with the clickable bars on Explore Fields via the same session
# key). Preferred state and Employment year only show where they apply.
# ═══════════════════════════════════════════════════════════════════════════
